        ...
        <div className="flex justify-center gap-5 py-10 w-3/4">
          ...
          <div className="w-3/4 pb-3 bg-white rounded-lg shadow-lg">
            ...
            <div className="flex justify-start mx-16 mt-2">
              <input
                type="text"
                className="w-full h-10 px-3 text-base border-b-2 focus:outline-none focus:border-gray-500 transition duration-500"
              />
            </div>
            <div className="flex justify-start ml-16 mt-5">
              <p>Scan IRS</p>
            ...
            <div className="flex justify-start mx-16 mt-2">
              ...
              <label
                for="dropzone-file"
                class="flex flex-col items-center justify-center w-full h-64 border-2 border rounded-xl cursor-pointer hover:bg-gray-100 "
              >
            ...
            <div className="flex justify-center mt-5">
              <button className="mb-2 px-10 h-10 text-white transition-colors duration-150 bg-violet-500 rounded-full shadow-lg focus:shadow-outline hover:bg-violet-600">
                Save
              </button>
            </div>
          </div>
