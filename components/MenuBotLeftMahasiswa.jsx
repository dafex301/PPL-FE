    ...
    <div className="bg-white rounded-lg shadow-lg mt-4 flex flex-col">
      <div>
        <Link href="/mahasiswa">
          <a>
            <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100 rounded-t-lg">
              ...
              <p
                className={
                  useRouter().pathname === "/mahasiswa" ? "" : "text-gray-500"
                }
              >
                Profile
              </p>
        ...
        <Link href="/mahasiswa/irs">
          <a>
            <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100">
              {useRouter().pathname === "/mahasiswa/irs" ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
        ...
        <Link href="/mahasiswa/khs">
          <a>
            <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100">
              {useRouter().pathname === "/mahasiswa/khs" ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
        ...
        <Link href="/mahasiswa/pkl">
          <a>
            <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100">
              {useRouter().pathname === "/mahasiswa/pkl" ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
        ...
        <Link href="/mahasiswa/skripsi">
          <a>
            <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100">
              {useRouter().pathname === "/mahasiswa/skripsi" ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
