...
export default function MenuBotLeftDepartemen(params) {
  return (
    <div className="bg-white rounded-lg shadow-lg mt-4 flex flex-col">
      <div>
        <Link href="/departemen">
          <a>
            <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100 rounded-t-lg">
              ...
              <p
                className={
                  useRouter().pathname === "/departemen" ? "" : "text-gray-500"
                }
              >
                Home
              </p>
        ...
        <Link href="/departemen/skripsi">
          <a>
            <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100">
              {useRouter().pathname === "/departemen/skripsi" ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
