...
export default function MenuBotLeftAdmin(params) {
  return (
    <div className="bg-white rounded-lg shadow-lg mt-4 flex flex-col">
      <div>
        <Link href="/admin">
          <a>
            <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100 rounded-t-lg">
              ...
              <p
                className={
                  useRouter().pathname === "/admin" ? "" : "text-gray-500"
                }
              >
                Home
              </p>
        ...
        <Link href="/admin/generate">
          <a>
            <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100 rounded-t-lg">
              {useRouter().pathname === "/admin/generate" ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
        ...
        <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100">
          ...
          <p
            className={
              useRouter().pathname === "/admin/accounts" ? "" : "text-gray-500"
            }
          >
            Manajemen Akun
          </p>
        ...
        <div className="flex items-center flex-row py-3 pl-3 hover:bg-gray-100">
          ...
          <p
            className={
              useRouter().pathname === "/admin/mahasiswa" ? "" : "text-gray-500"
            }
          >
            Data Mahasiswa
          </p>
