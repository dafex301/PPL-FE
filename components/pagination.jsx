    ...
    <>
      <nav>
        <ul className="flex justify-evenly pr-3 rounded items-center list-none flex-wrap">
          <a
            onClick={handleBack}
            className="border-solid border-violet-500 text-white bg-violet-500 rounded-full p-1 hover:bg-violet-700 items-center flex justify-center cursor-pointer"
          >
            <svg
